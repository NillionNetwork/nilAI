...
RUN touch crates/nilai-domain/src/lib.rs \
    crates/nilai-infra/src/lib.rs \
    crates/nilai-auth/src/lib.rs \
    crates/nilai-discovery/src/lib.rs \
    crates/nilai-api/src/main.rs \
    crates/nilai-model-daemon/src/main.rs

# Build release binaries
RUN cargo build --release --bin nilai-api --bin nilai-model-daemon
